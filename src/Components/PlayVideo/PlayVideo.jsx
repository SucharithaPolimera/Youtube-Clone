...
const PlayVideo = () => {
  ...
  const fetchOtherData = async () => {
    ...
    await fetch(commentsDetails_URL).then(response=>response.json()).then(data => {setCommentData(data.items);})
}
  ...
  return (
    <div className='play-video'>
        ...
        <div className="play-video-info">
            ...
            <div>
                <span><img src={like} alt="Like icon" />{apiData ? valueConverter(apiData.statistics.likeCount) : 155}</span>
        ...
        <div className='publisher'>
            <img src={channelData ? channelData.snippet.thumbnails.default.url : null} alt="UserProfile Picture"/>
            <div>
        ...
        <div className='video-description'>
            <p>{apiData ? apiData.snippet.description.slice(0, 215) : "Description Here"}</p>
            <hr/>
